...
# Links for the BoolQ task
train_file = "https://huggingface.co/datasets/PORTULAN/extraglue/resolve/main/data/boolq_pt-PT/train.jsonl"
val_file = "https://huggingface.co/datasets/PORTULAN/extraglue/resolve/main/data/boolq_pt-PT/validation.jsonl"
...
def tokenize_function(example):
    return tokenizer(example['passage'], example['question'], padding = True, truncation = True)
