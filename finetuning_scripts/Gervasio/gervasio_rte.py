...
# Links for the RTE task
train_file = "https://huggingface.co/datasets/PORTULAN/extraglue/resolve/main/data/rte_pt-PT/train.jsonl"
val_file = "https://huggingface.co/datasets/PORTULAN/extraglue/resolve/main/data/rte_pt-PT/validation.jsonl"
...
checkpoint = "PORTULAN/gervasio-7b-portuguese-ptpt-decoder"
...
#Original Validation Set -> New Test Set
...
def tokenize_function(example):
    return tokenizer(example["premise"], example["hypothesis"], padding = True, truncation=True)
...
training_args = TrainingArguments(
    ...
    per_device_train_batch_size = 1,            # batch size for training set
    per_device_eval_batch_size = 1,             # batch size for validation set (should be the same as above)
