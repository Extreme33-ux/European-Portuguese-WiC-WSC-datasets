...
train_file = "https://huggingface.co/datasets/PORTULAN/extraglue/resolve/main/data/stsb_pt-PT/train.jsonl"
val_file = "https://huggingface.co/datasets/PORTULAN/extraglue/resolve/main/data/stsb_pt-PT/validation.jsonl"
...
def compute_metrics(eval_pred):
    ...
    predictions = sigmoid(logits) * 5    # Scale sigmoid output to 0-5 range
    predictions = predictions.flatten()  # Ensure shape matches labels
